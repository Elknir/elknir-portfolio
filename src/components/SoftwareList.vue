<template>
  <div class="grid md:grid-cols-2 p-8 px-12 bg-[#151515]">
    <SoftwareCard v-for="software in orderedSoftwares" :key="software.id" :software="software" />
  </div>
</template>

<script setup lang="ts">
import { computed } from 'vue'
import { softwares } from '@/datas/softwares'
import SoftwareCard from '@/components/SoftwareComponent.vue'
